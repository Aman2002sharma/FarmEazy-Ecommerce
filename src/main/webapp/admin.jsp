<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
        ...
        List<Watch> lic=new WatchDaoImp().getAllWatch(); 
    %>
...
<title>Admin Page-FarmEazy</title>
 ...
 <div class="container admin mt-2">
     <%@ include file="components/message.jsp"%>
      <div class="row mt-3">
           ...
           <div class="col-md-3">
                  <div class="card hover" data-toggle="modal" data-target="#show-watch-modal">
                     <div class="card-body text-center">
                          <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/watch.png" alt="users_pic" >
                         </div>
                          <h1><%=new WatchDaoImp().getTotalWatch() %></h1>
      ...
      <div class="row mt-3" >
           <div class="col-md-3">
                 <div class="card hover" data-toggle="modal" data-target="#total-order-modal">
                     <div class="card-body text-center">
                         <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/totalorders.png" alt="users_pic" >
                         </div>
                  ...
                  <div class="card hover" data-toggle="modal" data-target="#add-category-modal">
                     <div class="card-body text-center">
                          <div class="container md-5">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/addbrand.png" alt="users_pic" >
                         </div>
           ...
           <div class="col-md-3">
                  <div class="card hover" data-toggle="modal" data-target="#add-watch-modal">
                     <div class="card-body text-center">
                          <div class="container md-5">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/addwatch.png" alt="users_pic" >
                         </div>
                          <p class="text-lowercase text-muted mt-2 " style="font-size:22px">click to add cate.</p>
                          <h2 class="text-uppercase text-muted mt-1">Add categories</h2>
                     </div>
                 </div>
           </div>
...
<div class="modal fade" id="add-watch-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header custom-bg text-white">
      ...
      <div class="modal-body">
          <form action="ProductOperationServlet" method="post">
               ...
               <div class="form-group">
                   <input type="text" class="form-control" name="watchTitle" placeholder="Enter Category Title here" required>
               </div>
               
               <div class="form-group">
                   <textarea style="height:250px" class="form-control" name="watchDescription" placeholder="Enter Category Description here" required></textarea>
               </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="ProductOperationServlet" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                   <select name="productWatchId" class="form-control">
                       <option value="0">Select Category</option>
                       <%
                           for(Watch watch:lic)
                           {
                       %>
                       <option value="<%=watch.getWatchId()%>"><%=watch.getWatchTitle() %></option>
                       <%
                           }
                       %>
                   </select>
...
<div class="modal fade" id="show-watch-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header custom-bg text-white text-center">
        <h5 class="modal-title" id="exampleModalLongTitle" >Total Categories</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <tbody>
   <%
      WatchDaoImp cdd=new WatchDaoImp();
      List<Watch> lcc=cdd.getAllWatch();
   %>
   ...
   %>
    <tr>
      <td class="mid-align"><%=c.getWatchId() %></td>
      <td class="mid-align"><%=c.getWatchTitle() %></td>
      <td class="mid-align"><%=c.getWatchDescription() %></td>
      <td class="mid-align"><a href="ProductOperationServlet?watchId=<%=c.getWatchId()%>&action=deleteWatch"><input type="submit" class="btn btn-danger" value="Delete"></a></td>
    </tr>
    <%
      }
    %>
  ...
  <tbody>
   ...
   %>
    <tr>
      ...
      <td class="mid-align"><%=new WatchDaoImp().getWatchNameById(p.getWatchId()) %></td>
