...
<%
     ...
     int watchId=product.getWatchId();
     
     List<Product> lop=new ProductDaoImp().getProductByBrandAndFor(watchId);
%>
...
<div class="container-fluid">
  ...
  <button type="submit" class="btn custom-bg" style="width:200px;">Search</button>
        ...
        <div class="col-sm-6 mt-4 admin">
              <div class="card">
                   <div class="card-header text-center">
                        <h3 class="text-muted text-left ml-4">Brand: <%=new BrandDaoImp().getBrandNameById(product.getCategoryId()) %> (<%=new WatchDaoImp().getWatchNameById(product.getWatchId()) %>) </h3>
